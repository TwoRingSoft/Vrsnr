...
//  Vrsnr
//
//  Created by Andrew McKnight on 10/23/18.
//  Copyright © 2018 Two Ring Software. All rights reserved.
//

import Foundation

public struct GemspecFile {
    public let path: String
}

extension GemspecFile: File {
    ...
    public func defaultKeyForVersionType(_ type: VersionType) -> String {
        return GemspecFile.defaultKeyForVersionType(type)
    }
...
extension GemspecFile: TextFile {
