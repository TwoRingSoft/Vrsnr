...
function runTestFlavor() {
    ...
    runTest "${VRSN_FILE_TYPE}-vrsn-minor${VRSN_FLAVOR_SUFFIX}-try" "${VRSN_FIXTURE_DIR}/Sample.${VRSN_FILE_TYPE}" "minor"     "${VRSN_TEST_FLAVOR_OPTIONS} --try"
    ...
    runTest "${VRSN_FILE_TYPE}-vrsn-minor${VRSN_FLAVOR_SUFFIX}-current-version-override" "${VRSN_FIXTURE_DIR}/Sample.${VRSN_FILE_TYPE}" "minor"     "${VRSN_TEST_FLAVOR_OPTIONS} --current-version 1.2.3"
    ...
    runTest "${VRSN_FILE_TYPE}-vrsn-minor${VRSN_FLAVOR_SUFFIX}-current-version-override-try" "${VRSN_FIXTURE_DIR}/Sample.${VRSN_FILE_TYPE}" "minor"     "${VRSN_TEST_FLAVOR_OPTIONS} --current-version 1.2.3 --try"
